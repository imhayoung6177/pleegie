  ...
  return (
    <div className="rrp-page">
      ...
      <div className="rrp-header">
        ...
        <span className="rrp-header-title">{selectedRecipe ? "레시피 상세" : "AI 추천 레시피"}</span>
      </div>
      ...
      <div className="rrp-body">
        ...
        {!loading && !errorMsg && !selectedRecipe && (
          <div className="rrp-recipe-list">
            {recipes.map((r, idx) => (
              <div key={idx} className="rrp-recipe-card" onClick={() => setSelectedRecipe(r)}>
        ...
        {!loading && !errorMsg && selectedRecipe && (
          <div className="rrp-detail">
            {/* 목록으로 돌아가기 버튼 */}
            <button className="rrp-back-btn" onClick={() => setSelectedRecipe(null)}>
              ← 목록으로
            </button>
            ...
            >
              <div style={{ fontSize: "0.82rem", color: "#8a7a60", marginBottom: "6px" }}>냉장고 재료 매칭률</div>
              <div
                style={{
                  height: "8px",
                  background: "#e8e3db",
            ...
            <div className="detail-section">
              <h3>💬 레시피 설명</h3>
              <p style={{ color: "#5a4a32", lineHeight: 1.6 }}>{selectedRecipe.description}</p>
            </div>
            ...
            <div className="detail-section">
              ...
              <ol style={{ paddingLeft: "20px", color: "#5a4a32", lineHeight: 2 }}>
                {Array.isArray(selectedRecipe.cooking_steps) ? (
                  selectedRecipe.cooking_steps.map((step, i) => <li key={i}>{step}</li>)
                ) : (
      ...
      {showMap && (
        ...
        >
          ...
          >
            ...
            >
              <span style={{ fontWeight: 700, fontSize: "1rem" }}>🏪 근처 시장 찾기</span>
              <button
            ...
            {mapLoading ? (
              ...
              <>
                ...
                >
                  {mapMarkets.length === 0 ? (
                    <p style={{ textAlign: "center", color: "#888" }}>근처 시장에 해당 재료가 없어요</p>
                  ) : (
                          ...
                          {market.items?.map((item, i) => (
                            <span
                              ...
                              style={{
                                ...
                                border: `1px solid ${item.onSale ? "#FF6B35" : "#4CAF50"}`,
                              }}
                            >
                              {item.onSale ? "🔴 " : ""}
                              {item.name}{" "}
